...
{
	var nobj = choose(obj_turd,obj_dead_rat,obj_blikje,obj_blikje,obj_blikje,obj_blikje,obj_blikje,obj_tuintafel,obj_vissengraat,obj_vissengraat,obj_vissengraat,obj_turd);
